...
import { History, Copy, Check, Heart, Trash2, Clock, Sparkles } from "lucide-react";
    ...
    <section className="mt-10 pt-8 border-t border-white/5">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-sm font-semibold text-zinc-200">Recent Translations</h2>
        ...
        {history.slice(0, 10).map((item) => {
          ...
          return (
            <div
              ...
              className="group relative rounded-xl p-3.5 bg-zinc-900/50 hover:bg-zinc-900 border border-zinc-800/80 hover:border-purple-500/30 transition-all cursor-pointer"
            >
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="flex items-center gap-1 shrink-0 opacity-80 group-hover:opacity-100 transition-opacity">
                  ...
                  <button
                    ...
                    className="p-1.5 text-zinc-400 hover:text-pink-400 rounded-lg hover:bg-zinc-800 transition-colors"
                    title="Favorite"
                  >
                    <Heart
                      className={`w-3.5 h-3.5 ${
                        item.isFavorite ? "fill-pink-500 text-pink-500" : ""
                      }`}
                    />
                  </button>
